...
## 👥 Público-Alvo
* **Estudantes:** Usuários centrais que consumirão o acervo literário, produzirão as resenhas e interagirão com seus pares no sistema.
...
* **Interações:** Validação social das análises publicadas por outros usuários.
...
* **RF04 - Cadastro de Conteúdos:** O sistema deve permitir que administradores cadastrem, editem conteúdos literários disponíveis para leitura.
...
* **RNF03 - Performance:** O carregamento da página inicial não deve exceder 2 segundos em conexões padrão.
* **RNF04 - Integridade:** O banco de dados deve seguir o modelo relacional normalizado (até a 3FN) garantindo integridade referencial.
...
* **Fluxo geral da aplicação:** O usuário interage com as interfaces web gerando requisições HTTP; o servidor valida regras de negócio (como login e notas válidas entre 1 e 5), comunica-se com o banco relacional para leitura ou escrita e devolve a resposta atualizada para compor dinamicamente a tela do usuário.
